						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="grey" id="id-text2"><?php echo $site_name ?></span>
								</h1>
							</div>
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="" class="vform" name="loginform">
												<input type="hidden" name="form" value="login">
												<input type="hidden" name="validform" value="<?=$this->validform;?>">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input name="login" type="email" class="form-control" placeholder="Логин" required/>
								...
								<div id="forgot-box" class="forgot-box widget-box no-border">
									<div class="widget-body">
										<div class="widget-main" id="forgot-box-main">
											...
											<form>
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" id="re_email" class="form-control" placeholder="Email"/>
															<i class="ace-icon fa fa-envelope"></i>
														</span>
													</label>

													<div class="clearfix">
														<button type="button" class="btn_respas width-35 pull-right btn btn-sm btn-danger">
